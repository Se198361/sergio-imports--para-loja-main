...
```bash
git remote add encore encore://sergio-imports-sales-system-hiri
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/sergio-imports-sales-system-hiri/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/sergio-imports-sales-system-hiri/settings/integrations/github)
